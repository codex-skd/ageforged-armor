...
> Este archivo pertenece al proyecto **Ageforged Armor**. Cambios aquí solo afectan a este proyecto.
...
| Dato | Valor |
|---|---|
| Mod ID (`gradle.properties`) | `ageforged_armor` |
| Clase principal | `AgeforgedArmor` |
| Display name (Title Case) | `Ageforged Armor` |
...
|---|---|---|
| **snake_case** | `mod_id`, assets/, packages Java | `ageforged_armor` |
| **PascalCase** | Clases Java principales | `AgeforgedArmor` |
| **camelCase** | Variables, métodos, config keys | `ageforged_armorConfig` |
| **Title Case** | Display name (README, CHANGELOG, docs, CurseForge) | `Ageforged Armor` |
