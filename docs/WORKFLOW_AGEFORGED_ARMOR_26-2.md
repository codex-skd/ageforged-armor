...
|---|---|---|
| WORKFLOW | `WORKFLOW_<MOD_ID>_<MC-VERSION>.md` | `WORKFLOW_AGEFORGED_ARMOR_26-2.md` |
...
├── docs/
│   ├── WORKFLOW_AGEFORGED_ARMOR_26-2.md  # Este documento
...
| Ejemplo | Significado |
|---------|-------------|
| `ageforged_armor-26.2-neoforge-0.0.0-beta.27.jar` | NeoForge 26.2, beta 27 |
