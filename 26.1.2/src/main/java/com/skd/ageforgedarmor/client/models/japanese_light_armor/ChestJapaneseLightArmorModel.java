package com.skd.ageforgedarmor.client.models.japanese_light_armor;
...
public class ChestJapaneseLightArmorModel<T extends HumanoidRenderState> extends ArmorModel<T> {
