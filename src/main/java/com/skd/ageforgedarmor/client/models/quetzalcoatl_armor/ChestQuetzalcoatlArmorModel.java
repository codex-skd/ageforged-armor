package com.skd.ageforgedarmor.client.models.quetzalcoatl_armor;
...
public class ChestQuetzalcoatlArmorModel<T extends HumanoidRenderState> extends ArmorModel<T> {
